    ...
    <div ref={sectionRef} style={{ position: "absolute", inset: 0, pointerEvents: "none" }}>
      ...
      <motion.div
        style={{
          ...
          filter: "sepia(10%) saturate(80%) hue-rotate(95deg) brightness(0.88)",
        }}
        initial={{ x: -65, y: 65, rotate: 18, opacity: 0, scale: 0.80 }}
        animate={isInView ? { x: 0, y: 0, rotate: -10, opacity: 1, scale: 1 } : {}}
        transition={{ duration: 1.0, delay: 0.25, ease: [0.34, 1.15, 0.64, 1] }}
      >
        <motion.div
          animate={isInView ? {
            x: [0, -3, -5, -4, -2, 1, 0],
        ...
        >
          <svg viewBox="0 0 260 320" xmlns="http://www.w3.org/2000/svg" fill="none" width={280} height={340}>
            ...
            <g filter="url(#handShadowLMain)">
              ...
              <rect x="58" y="108" width="144" height="88" rx="14" fill="url(#woodGradLMain)"/>
              ...
              <text x="130" y="148" textAnchor="middle" fontFamily="sans-serif" fontSize="13" fontWeight="700" letterSpacing="2.5" fill="rgba(0,0,0,0.32)">STAMPIFY</text>
      ...
      <motion.div
        ...
        initial={{ x: 65, y: 65, rotate: -18, opacity: 0, scale: 0.80 }}
        animate={isInView ? { x: 0, y: 0, rotate: 10, opacity: 1, scale: 1 } : {}}
        transition={{ duration: 1.0, delay: 0.45, ease: [0.34, 1.15, 0.64, 1] }}
      >
        <motion.div
          animate={isInView ? {
            x: [0, 4, 6, 3, -1, 0],
        ...
        >
          <svg viewBox="0 0 240 300" xmlns="http://www.w3.org/2000/svg" fill="none" width={240} height={300}>
            <defs>
              <filter id="handShadowRMain">
                <feDropShadow dx="0" dy="8" stdDeviation="14" floodColor="rgba(0,0,0,0.15)" floodOpacity="1"/>
              </filter>
              <linearGradient id="woodGradRMain" x1="100%" y1="0%" x2="0%" y2="100%">
                <stop offset="0%" stopColor="#C8A060"/>
                <stop offset="45%" stopColor="#A07040"/>
                <stop offset="100%" stopColor="#C8A060"/>
              </linearGradient>
            </defs>
            <g filter="url(#handShadowRMain)">
              ...
              <rect x="52" y="95" width="136" height="82" rx="12" fill="url(#woodGradRMain)"/>
              <rect x="58" y="101" width="124" height="70" rx="10" fill="#1a1a2e"/>
              <text x="120" y="128" textAnchor="middle" fontFamily="sans-serif" fontSize="10" fontWeight="600" fill="#1d9e75">✓ Carte ouverte</text>
              <text x="120" y="142" textAnchor="middle" fontFamily="sans-serif" fontSize="9" fill="rgba(255,255,255,0.6)">8/10 tampons</text>

...
/**
 * v5 PhoneMockup — iPhone 15-ish stylisé affichant la carte fidélité Stampify.
 *
 * Inspiration : topanga.io, searchable.com, karumi.ai
 * - châssis titanium dégradé, écran noir, notch Dynamic Island
 * - carte fidélité Stampify à l'écran : header marque, grille 10 tampons
 *   (7/10 remplis), barre de progression
 * - flottement organique doux (6s, easeInOut) + légère rotation
 * - ombre réaliste multi-couches sous le téléphone, elle aussi animée
 * - rien d'autre — pas d'orbs, pas de beams
 *
 * Dimensions : 280 × 572 px (ratio iPhone 15 ≈ 0.49).
 */

...
const NAV_LINKS = [
  { label: "Fonctionnalités", href: "/v5/#features" },
  { label: "Tarif", href: "/v5/#pricing" },
  { label: "Démos", href: "/v5/demos" },
      ...
      <div style={{
        ...
        <div style={{
          ...
          <span className="v2-announce-text">
            ...
            <Link href="/v5/#pricing" style={{ color: "#1d9e75", fontWeight: 700, textDecoration: "underline" }}>
              En savoir plus →
            </Link>
          </span>
        </div>

  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <main className="max-w-3xl mx-auto px-6 py-16">
        <h1 className="text-3xl font-black text-gray-900 mb-4">Mentions légales</h1>
        ...
        <div className="prose text-gray-600 text-sm leading-relaxed space-y-4">
          <p>Cette page sera complétée prochainement avec les mentions légales de Stampify.</p>
        </div>
      </main>
    </div>
  );

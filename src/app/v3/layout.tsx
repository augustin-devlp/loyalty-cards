...
export const metadata: Metadata = {
  title: "Stampify v3 — Design preview",
...
export default function V3Layout({ children }: { children: React.ReactNode }) {
  return (
    <>
      ...
      {/* Footer */}
      <footer style={{ background: "#f5f5f7", padding: "60px 20px 40px", fontFamily: "'Inter', -apple-system, BlinkMacSystemFont, sans-serif" }}>
        <div style={{ maxWidth: "860px", margin: "0 auto", display: "flex", flexDirection: "column", alignItems: "center", gap: "24px" }}>
          <Link href="/v3" style={{ textDecoration: "none" }}>
            <div style={{ width: "32px", height: "32px", background: "#1d1d1f", borderRadius: "8px", display: "flex", alignItems: "center", justifyContent: "center" }}>
          ...
          <div style={{ display: "flex", flexWrap: "wrap", gap: "8px 24px", justifyContent: "center" }}>
            {[
              ...
              <Link key={link.href} href={link.href} style={{ fontSize: "13px", color: "#6e6e73", textDecoration: "none" }}>
                {link.label}
              </Link>
            ))}
          </div>

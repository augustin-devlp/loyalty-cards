...
export const metadata: Metadata = {
  title: "Nail Studio — Démo Stampify",
  description: "Exemple de site web pour un salon de manucure à Lausanne avec carte de fidélité digitale. Livré par Stampify en 48h.",
};
...
const menu = [
  { name: "Manucure classique", price: "45.00 CHF", desc: "Soin des mains, pose vernis couleur, finition" },
  { name: "Pose gel complète", price: "85.00 CHF", desc: "Extensions ou capsules, gel couleur UV, renfort" },
  { name: "Nail art personnalisé", price: "120.00 CHF", desc: "Création sur mesure, motifs, dégradé, strass" },
  { name: "Pédicure complète", price: "55.00 CHF", desc: "Soin des pieds, bain, vernis, massage" },
];
...
export default function ManucurePage() {
  return (
    <div style={{ fontFamily: "'DM Sans', sans-serif", background: "#FAFAF8" }}>
      ...
      <nav style={{ background: PRIMARY, padding: "0 24px", position: "sticky", top: 56, zIndex: 40 }}>
        <div style={{ maxWidth: 1100, margin: "0 auto", display: "flex", justifyContent: "space-between", alignItems: "center", height: 60 }}>
          ...
          <div style={{ display: "flex", gap: 24 }}>
            {["Services", "Notre studio", "Fidélité", "Réservation"].map((item) => (
      ...
      {/* Hero */}
      <section style={{ background: `linear-gradient(135deg, #880E4F 0%, ${PRIMARY} 100%)`, padding: "80px 24px 72px", textAlign: "center" }}>
        <div style={{ maxWidth: 720, margin: "0 auto" }}>
          ...
          <h1 style={{ fontFamily: "Fraunces, Georgia, serif", fontSize: "clamp(36px, 5vw, 60px)", fontWeight: 700, color: "white", margin: "0 0 16px 0", letterSpacing: "-0.02em", lineHeight: 1.15 }}>
            Nail art & beauté<br /><em style={{ fontStyle: "italic" }}>à Lausanne</em>
          </h1>
          <p style={{ fontSize: 17, color: "rgba(255,255,255,0.8)", lineHeight: 1.7, margin: "0 0 32px 0" }}>
            Vos mains méritent ce qu&apos;il y a de mieux. Vernis, gel, nail art — chaque création est unique, comme vous.
          </p>
      ...
      {/* About */}
      <section id="notre-studio" style={{ background: "white", padding: "72px 24px" }}>
        <div style={{ maxWidth: 800, margin: "0 auto", display: "grid", gridTemplateColumns: "1fr 1fr", gap: 48, alignItems: "center" }}>
          <div>
            <div style={{ fontSize: 11, fontWeight: 700, letterSpacing: "0.12em", textTransform: "uppercase", color: PRIMARY, marginBottom: 12 }}>Notre studio</div>
            ...
            <p style={{ color: "#6B6259", lineHeight: 1.75, margin: "0 0 16px 0" }}>
              Ouvert en 2020 par Sofia, Nail Studio est rapidement devenu l&apos;adresse de référence à Lausanne pour les amateurs de nail art. Sofia forme régulièrement ses équipes aux dernières tendances de Tokyo et New York.
            </p>
            <p style={{ color: "#6B6259", lineHeight: 1.75 }}>
              Nous utilisons exclusivement des produits certifiés sans substances nocives, respectueux de vos ongles et de votre santé. Chaque outil est stérilisé entre chaque client.
            </p>
          </div>
          <div style={{ background: LIGHT, borderRadius: 20, padding: 32, textAlign: "center" }}>
            ...
            <div style={{ color: "#6B6259", fontSize: 14, marginTop: 4 }}>Mar–Sam : 9h – 19h</div>
            <div style={{ color: "#6B6259", fontSize: 14 }}>Dim–Lun : fermé</div>
          </div>
        </div>
      </section>
      ...
      <section id="services" style={{ background: LIGHT, padding: "72px 24px" }}>
        <div style={{ maxWidth: 800, margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: 48 }}>
            <div style={{ fontSize: 11, fontWeight: 700, letterSpacing: "0.12em", textTransform: "uppercase", color: PRIMARY, marginBottom: 12 }}>Prestations</div>
            <h2 style={{ fontFamily: "Fraunces, Georgia, serif", fontSize: 32, fontWeight: 700, color: "#1A1410", margin: 0 }}>Nos soins</h2>
          </div>
      ...
      <section id="fidelite" style={{ background: "white", padding: "72px 24px" }}>
        <div style={{ maxWidth: 700, margin: "0 auto", textAlign: "center" }}>
          ...
          <h2 style={{ fontFamily: "Fraunces, Georgia, serif", fontSize: 32, fontWeight: 700, color: "#1A1410", margin: "0 0 16px 0" }}>
            Pose offerte après 10 visites
          </h2>
          <p style={{ color: "#6B6259", lineHeight: 1.7, marginBottom: 40, fontSize: 16 }}>
            Chaque rendez-vous est récompensé. Approchez votre téléphone de la plaquette NFC à l&apos;accueil ou scannez le QR code.
          </p>
          <div style={{ background: LIGHT, border: "1px solid #E2D9CC", borderRadius: 20, padding: "32px", display: "inline-block", minWidth: 300 }}>
            <div style={{ fontSize: 13, fontWeight: 700, color: "#1A1410", marginBottom: 20 }}>Votre carte récompenses</div>
      ...
      <section id="reservation" style={{ background: "white", padding: "72px 24px" }}>
        <div style={{ maxWidth: 600, margin: "0 auto", textAlign: "center" }}>
          <div style={{ fontSize: 11, fontWeight: 700, letterSpacing: "0.12em", textTransform: "uppercase", color: PRIMARY, marginBottom: 12 }}>Rendez-vous</div>
          <h2 style={{ fontFamily: "Fraunces, Georgia, serif", fontSize: 28, fontWeight: 700, color: "#1A1410", margin: "0 0 24px 0" }}>Réservez votre soin</h2>
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 20 }}>
            {[
              { icon: "📍", label: "Adresse", value: "15 Rue de Bourg, 1003 Lausanne" },
              { icon: "📞", label: "Téléphone", value: "+41 21 000 00 00" },
              { icon: "✉️", label: "Email", value: "rdv@nail-studio.ch" },
            ].map((c) => (
      ...
      <footer style={{ background: "#1A1410", padding: "24px", textAlign: "center" }}>
        <p style={{ color: "rgba(255,255,255,0.4)", fontSize: 13, margin: 0 }}>
          Nail Studio © 2026 · Site créé par{" "}

...
export const metadata: Metadata = {
  title: "Le Bistrot — Démo Stampify",
  description: "Exemple de site web pour un restaurant à Fribourg avec carte de fidélité digitale. Livré par Stampify en 48h.",
};
...
const menu = [
  { name: "Fondue fribourgeoise", price: "28.00 CHF", desc: "Gruyère AOP et Vacherin fribourgeois, vin blanc du Vully" },
  { name: "Rösti maison", price: "18.00 CHF", desc: "Pommes de terre vaudoises, lardons fumés, crème fraîche" },
  { name: "Filets de perche", price: "26.00 CHF", desc: "Lac de Neuchâtel, meunière au beurre noisette, citron" },
  { name: "Tiramisu du jour", price: "9.00 CHF", desc: "Mascarpone, café arabica, biscuits cuillère maison" },
];
...
export default function RestaurantPage() {
  return (
    <div style={{ fontFamily: "'DM Sans', sans-serif", background: "#FAFAF8" }}>
      ...
      <nav style={{ background: PRIMARY, padding: "0 24px", position: "sticky", top: 56, zIndex: 40 }}>
        <div style={{ maxWidth: 1100, margin: "0 auto", display: "flex", justifyContent: "space-between", alignItems: "center", height: 60 }}>
          ...
          <div style={{ display: "flex", gap: 24 }}>
            {["Carte", "Notre cuisine", "Fidélité", "Réservation"].map((item) => (
      ...
      {/* Hero */}
      <section style={{ background: `linear-gradient(135deg, #5C0F0F 0%, ${PRIMARY} 100%)`, padding: "80px 24px 72px", textAlign: "center" }}>
        <div style={{ maxWidth: 720, margin: "0 auto" }}>
          ...
          <h1 style={{ fontFamily: "Fraunces, Georgia, serif", fontSize: "clamp(36px, 5vw, 60px)", fontWeight: 700, color: "white", margin: "0 0 16px 0", letterSpacing: "-0.02em", lineHeight: 1.15 }}>
            Cuisine du terroir<br /><em style={{ fontStyle: "italic" }}>fribourgeois</em>
          </h1>
          <p style={{ fontSize: 17, color: "rgba(255,255,255,0.8)", lineHeight: 1.7, margin: "0 0 32px 0" }}>
            Fondues, röstis et spécialités locales préparés avec les producteurs de la région. Une table chaleureuse au cœur de la vieille ville.
          </p>
      ...
      {/* About */}
      <section id="notre-cuisine" style={{ background: "white", padding: "72px 24px" }}>
        <div style={{ maxWidth: 800, margin: "0 auto", display: "grid", gridTemplateColumns: "1fr 1fr", gap: 48, alignItems: "center" }}>
          <div>
            <div style={{ fontSize: 11, fontWeight: 700, letterSpacing: "0.12em", textTransform: "uppercase", color: PRIMARY, marginBottom: 12 }}>Notre cuisine</div>
            <h2 style={{ fontFamily: "Fraunces, Georgia, serif", fontSize: 32, fontWeight: 700, color: "#1A1410", margin: "0 0 16px 0", lineHeight: 1.2 }}>
              Le meilleur du terroir fribourgeois
            </h2>
            <p style={{ color: "#6B6259", lineHeight: 1.75, margin: "0 0 16px 0" }}>
              Depuis 2008, Le Bistrot célèbre les saveurs authentiques de la région. Gruyère AOP, Vacherin fribourgeois, perches du lac — nous travaillons avec des producteurs locaux que nous connaissons personnellement.
            </p>
            <p style={{ color: "#6B6259", lineHeight: 1.75 }}>
              Notre cave à vins propose une sélection exclusive de crus fribourgeois et vaudois, mariage parfait avec nos spécialités fromagères.
            </p>
          </div>
          <div style={{ background: LIGHT, borderRadius: 20, padding: 32, textAlign: "center" }}>
            ...
            <div style={{ color: "#6B6259", fontSize: 14 }}>1700 Fribourg</div>
            <div style={{ color: "#6B6259", fontSize: 14, marginTop: 4 }}>Mar–Sam : 11h30 – 14h, 18h – 22h</div>
            <div style={{ color: "#6B6259", fontSize: 14 }}>Dim : 11h30 – 15h</div>
          </div>
        </div>
      </section>
      ...
      <section id="carte" style={{ background: LIGHT, padding: "72px 24px" }}>
        <div style={{ maxWidth: 800, margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: 48 }}>
            <div style={{ fontSize: 11, fontWeight: 700, letterSpacing: "0.12em", textTransform: "uppercase", color: PRIMARY, marginBottom: 12 }}>Carte</div>
            <h2 style={{ fontFamily: "Fraunces, Georgia, serif", fontSize: 32, fontWeight: 700, color: "#1A1410", margin: 0 }}>Nos spécialités</h2>
          </div>
      ...
      <section id="fidelite" style={{ background: "white", padding: "72px 24px" }}>
        <div style={{ maxWidth: 700, margin: "0 auto", textAlign: "center" }}>
          ...
          <h2 style={{ fontFamily: "Fraunces, Georgia, serif", fontSize: 32, fontWeight: 700, color: "#1A1410", margin: "0 0 16px 0" }}>
            Dessert offert après 10 visites
          </h2>
          <p style={{ color: "#6B6259", lineHeight: 1.7, marginBottom: 40, fontSize: 16 }}>
            Chaque repas compte. Scannez le QR code à table ou approchez votre téléphone de la plaquette NFC à l&apos;entrée du restaurant.
          </p>
      ...
      <section id="reservation" style={{ background: "white", padding: "72px 24px" }}>
        <div style={{ maxWidth: 600, margin: "0 auto", textAlign: "center" }}>
          ...
          <h2 style={{ fontFamily: "Fraunces, Georgia, serif", fontSize: 28, fontWeight: 700, color: "#1A1410", margin: "0 0 24px 0" }}>Réservez votre table</h2>
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 20 }}>
            {[
              { icon: "📍", label: "Adresse", value: "3 Place de l'Hôtel-de-Ville, 1700 Fribourg" },
              { icon: "📞", label: "Téléphone", value: "+41 26 000 00 00" },
              { icon: "✉️", label: "Email", value: "contact@le-bistrot.ch" },
            ].map((c) => (
